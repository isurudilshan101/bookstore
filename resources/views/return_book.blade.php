...
@section('content')
       ...
       <div class="container">
        ...
        <form method="POST" >
            {{--  action="{{ route('issue_books_return',$book->id) }}"  --}}
            
            @csrf

            <div class="mb-3">
                <label for="title" class="form-label">Book ID</label>
                <input type="text" class="form-control w-50" id="book_id" name="book_id"  required  >
            </div>
            ...
            <div class="mb-3">
                <label for="select_issue_return" class="form-label">Select Return</label>
